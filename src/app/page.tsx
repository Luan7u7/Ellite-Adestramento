...
const Home: NextPage =() => {
  ...
  return (
    <>
      <main className="relative my-0 mx-auto w-screen h-screen bg-[#191616] ">

        <h1 className={` font-WorkSans text-white text-[3.3rem] font-ws font-bold uppercase leading-[3.7rem] w-[22rem] text-right absolute top-4 right-3`}>
      ...
      <div className="w-32 h-1 bg-white p-[2px] rounded-full mt-2 z-10"/>
        ...
        <Next name="começar" url="/agendamento"
